  ...
  const T = {
    ...
    home: {
      ar: {
        ...
        home_h2: "تخصص أمن سيبراني — مصمم جرافيك وكاتب محتوى",
        about_h: "نبذة",
        about_p1:
          "أنا طالب أمن سيبراني ومصمم جرافيك وكاتب محتوى عربي. أصنع تصاميم عصرية (شعارات، بوستات، عروض تقديمية) ونصوصًا واضحة تساعد العلامات على الظهور بثقة.",
      ...
      en: {
        ...
        home_h1: "Mohamad Khaled Al-Shlool",
        home_h2: "Cybersecurity student — Graphic Designer & Copywriter",
        about_h: "About",
        about_p1:
          "I’m a cybersecurity student, graphic designer, and Arabic copywriter. I create modern visuals (logos, social posts, presentations) and clear copy that builds trust.",
        about_p2:
